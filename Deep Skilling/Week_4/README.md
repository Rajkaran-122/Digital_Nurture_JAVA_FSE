...
A complete distributed system utilizing Netflix Eureka and Spring Cloud Gateway. *(Note: The execution output images for these services were not provided in the original folder, so we are proudly displaying their architecture diagrams instead!)*

### Core Services
![Account Service](2_api-gateway/outputs/account-service-arch.png)
![Loan Service](2_api-gateway/outputs/loan-service-arch.png)
![Greet Service](2_api-gateway/outputs/greet-service-arch.png)
